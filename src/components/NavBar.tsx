...
export const NavBar: React.FC<NavBarProps> = ({
  ...
  return (
    <motion.nav
      ...
      className="md:hidden fixed bottom-0 left-0 right-0 w-full z-[110] rounded-t-2xl flex flex-col justify-start shadow-[0_-10px_30px_rgba(0,0,0,0.08)] border-t border-[#ECECEC] dark:border-white/10 bg-white/95 dark:bg-[#4A0517]/95 backdrop-blur-md"
      style={{ 
